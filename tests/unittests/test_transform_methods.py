...
class TransformMethods(unittest.TestCase):
    ...
    def test_denest_embedded_nodes(self):
            ...
            "conversations": [
                {
                    ...
                    "_embedded": {
                        ...
                        "emails": ["adbc_test@google.com", "test_acc@google.com"],
                        "social_profiles": {
                            "linkedin": "https://www.linkedin.com/in" "/test-user-11122330b",
        ...
        self.assertEqual(transform.transform_json(mock_input, "conversations"), expected_output)
