...
class TestDevModeImplementation(unittest.TestCase):
    ...
    def test_dev_mode_with_valid_access_token(self):
        """Verifies whether the __access_token attr has value from config in dev_mode
        implementation"""
    ...
    def test_dev_mode_with_invalid_access_token(self):
        """Verifies whether the get_access_token method throws an exception when access_token is
        None in config"""
    ...
    def test_non_dev_mode_writes_to_config(self, mock_request):
        """Tests whether the get_access_token method writes to config file when running the tap
        on non dev_mode"""
